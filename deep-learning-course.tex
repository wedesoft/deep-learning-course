...
In one-shot learning one learns a dissimilarity function $d$
...
A siamese network $f$ is a network given to images $x^{(i)}$ and $x^{(j)}$ allows you to define the dissimilarity function as follows
\begin{equation}
